...
public class trackCreator : MonoBehaviour
{
    ...
    */
    ...
    private void AddVertices()
    {
        ...
        //TL Line
        glowLineTLVerticesList.Add(vertex2 - trackHead.transform.right * .3f + trackHead.transform.up * 0.01f);
        glowLineTLVerticesList.Add(vertex4 + trackHead.transform.up * 0.01f);

        //TR Line
        glowLineTRVerticesList.Add(vertex5 + trackHead.transform.up * 0.01f);
        glowLineTRVerticesList.Add(vertex3 + trackHead.transform.right * .3f + trackHead.transform.up * 0.01f);
